...
export const en = {
  ...
  "common.retry": "Retry",
  "remote.title": "Remote",
  "remote.subtitle": "Connect this OpenCodex installation to your account, then reach its local GUI through a private Cloudflare Tunnel.",
  "remote.refresh": "Refresh Remote status",
  "remote.progressLabel": "Remote setup progress",
  "remote.stepAccount": "GitHub account",
  "remote.stepPassword": "Access password",
  "remote.stepTunnel": "Tunnel",
  ...
  "remote.signedOutBody": "Sign in through the OpenCodex service. GitHub verifies your identity; this local OCX receives only an OpenCodex device credential.",
  "remote.signIn": "Continue with GitHub",
  ...
  "remote.tunnelBody": "Remote traffic will enter through Cloudflare Tunnel instead of exposing your home or office network.",
  ...
  "remote.pendingBody": "Finish GitHub sign-in on opencodexpages.me and confirm that the code shown there matches this local code.",
  ...
  "remote.passwordBody": "This password protects remote browser access and is separate from your GitHub password.",
  ...
  "remote.domainBody": "OpenCodex will provision the private Tunnel and reserve one opencodexpages.me address for this PC.",
  ...
  "remote.provisioningTitle": "Creating the private Tunnel",
  "remote.provisioningBody": "The central service is reserving the address and creating this PC's isolated Cloudflare resources.",
  "remote.connectorTitle": "Connect the local helper",
  "remote.connectorBody": "The address is ready. Pair the signed Linux helper that keeps the local OCX and Cloudflare Tunnel connected.",
  ...
  "remote.prepareConnector": "Prepare connector",
  "remote.connectorRequirement": "Current private MVP: the signed Linux helper must be installed with administrator approval. Windows and macOS helpers are not shipped yet.",
  ...
  "remote.readyBody": "This computer's local OpenCodex GUI is available through its authenticated address.",
  "remote.openRemote": "Open Remote GUI",

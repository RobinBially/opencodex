...
export const ru: Record<TKey, string> = {
  ...
  "remote.subtitle": "Подключите этот OpenCodex к аккаунту и открывайте локальный GUI через приватный Cloudflare Tunnel.",
  ...
  "remote.tunnelBody": "Трафик идёт через Cloudflare Tunnel без публикации домашней или офисной сети.",
  ...
  "remote.domainBody": "OpenCodex создаст приватный Tunnel и зарезервирует адрес opencodexpages.me для этого ПК.",
  ...
  "remote.provisioningTitle": "Создание приватного Tunnel",
  "remote.provisioningBody": "Центральный сервис резервирует адрес и создаёт изолированные ресурсы Cloudflare.",
  "remote.connectorTitle": "Подключите локальный помощник",
  "remote.connectorBody": "Адрес готов. Выполните сопряжение подписанного Linux-помощника.",
  ...
  "remote.connectorRequirement": "Закрытый MVP требует установки подписанного Linux-помощника с правами администратора. Windows и macOS пока не поставляются.",
  "remote.connectingTitle": "Подключение компьютера",
  "remote.connectingBody": "Помощник сопряжён. Ожидаются проверки OCX, Agent, Tunnel и Gateway.",

...
export const zh: Record<TKey, string> = {
  ...
  "remote.tunnelBody": "远程流量通过 Cloudflare Tunnel 进入，不暴露家庭或办公网络。",
  ...
  "remote.domainBody": "OpenCodex 将创建专用私有隧道并保留一个 opencodexpages.me 地址。",
  ...
  "remote.provisioningTitle": "正在创建私有隧道",
  "remote.provisioningBody": "中央服务正在保留地址并创建这台电脑的 Cloudflare 资源。",
  "remote.connectorTitle": "连接本地助手",
  "remote.connectorBody": "地址已就绪。请配对保持本地 OCX 和 Cloudflare Tunnel 在线的已签名 Linux 助手。",
  "remote.pairingCode": "一次性配对码",
  "remote.pairingFailed": "无法准备连接器配对。",
  "remote.preparingConnector": "准备中…",
  "remote.prepareConnector": "准备连接器",
  "remote.connectorRequirement": "当前私测版需要管理员批准安装已签名 Linux 助手；暂未提供 Windows 和 macOS 版本。",
  "remote.connectingTitle": "正在连接这台电脑",
  "remote.connectingBody": "助手已配对，正在等待 OCX、Agent、Tunnel 和 Gateway 检查通过。",

...
export const ko: Record<TKey, string> = {
  ...
  "common.retry": "재시도",
  "remote.title": "리모트",
  "remote.subtitle": "이 컴퓨터의 OpenCodex를 계정에 연결하고, 로컬 GUI를 비공개 Cloudflare Tunnel로 접속합니다.",
  "remote.refresh": "리모트 상태 새로고침",
  "remote.progressLabel": "리모트 설정 진행 상태",
  "remote.stepAccount": "GitHub 계정",
  "remote.stepPassword": "접속 비밀번호",
  "remote.stepTunnel": "터널",
  "remote.loading": "리모트 상태를 불러오는 중…",
  "remote.loadFailed": "리모트 상태를 불러오지 못했습니다.",
  "remote.signedOutTitle": "이 컴퓨터 연결",
  "remote.signedOutBody": "OpenCodex 서비스를 통해 로그인합니다. GitHub는 신원만 확인하며, 이 로컬 OCX에는 OpenCodex 장치 자격증명만 전달됩니다.",
  "remote.signIn": "GitHub로 계속",
  ...
  "remote.tunnelBody": "집이나 사무실 네트워크를 직접 노출하지 않고 Cloudflare Tunnel로 원격 트래픽을 받습니다.",
  "remote.startFailed": "GitHub 로그인을 시작하지 못했습니다.",
  "remote.cancelFailed": "장치 로그인을 취소하지 못했습니다.",
  "remote.pendingTitle": "브라우저에서 이 컴퓨터를 승인하세요",
  "remote.pendingBody": "opencodexpages.me에서 GitHub 로그인을 마치고 사이트의 코드가 아래 로컬 코드와 같은지 확인하세요.",
  ...
  "remote.domainBody": "OpenCodex가 이 PC 전용 비공개 터널을 만들고 opencodexpages.me 주소 하나를 예약합니다.",
  ...
  "remote.provisioningTitle": "비공개 터널 생성 중",
  "remote.provisioningBody": "중앙 서버가 주소를 예약하고 이 PC 전용 Cloudflare 리소스를 만들고 있습니다.",
  "remote.connectorTitle": "로컬 헬퍼 연결",
  "remote.connectorBody": "주소 준비가 끝났습니다. 로컬 OCX와 Cloudflare Tunnel을 유지하는 서명된 Linux 헬퍼를 페어링하세요.",
  "remote.pairingCode": "일회용 페어링 코드",
  "remote.pairingFailed": "커넥터 페어링을 준비하지 못했습니다.",
  "remote.preparingConnector": "준비 중…",
  "remote.prepareConnector": "커넥터 준비",
  "remote.connectorRequirement": "현재 비공개 MVP는 관리자 승인을 받아 서명된 Linux 헬퍼를 설치해야 합니다. Windows와 macOS 헬퍼는 아직 배포하지 않습니다.",
  ...
  "remote.readyBody": "이 컴퓨터의 로컬 OpenCodex GUI를 인증된 주소로 접속할 수 있습니다.",
  "remote.openRemote": "리모트 GUI 열기",

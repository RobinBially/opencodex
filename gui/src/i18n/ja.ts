...
export const ja: Record<TKey, string> = {
  ...
  "remote.tunnelBody": "自宅や社内ネットワークを公開せず、Cloudflare Tunnel でリモート通信を受けます。",
  ...
  "remote.domainBody": "OpenCodex が専用のプライベート Tunnel と opencodexpages.me アドレスを作成します。",
  ...
  "remote.provisioningTitle": "プライベート Tunnel を作成中",
  "remote.provisioningBody": "中央サービスがアドレスと専用 Cloudflare リソースを作成しています。",
  "remote.connectorTitle": "ローカルヘルパーを接続",
  "remote.connectorBody": "アドレスの準備ができました。署名済み Linux ヘルパーをペアリングしてください。",
  ...
  "remote.connectorRequirement": "現在のプライベート MVP は管理者承認で Linux ヘルパーをインストールする必要があります。Windows/macOS 版は未提供です。",
  "remote.connectingTitle": "このコンピューターを接続中",
  "remote.connectingBody": "ヘルパーはペアリング済みです。OCX、Agent、Tunnel、Gateway の確認を待っています。",
